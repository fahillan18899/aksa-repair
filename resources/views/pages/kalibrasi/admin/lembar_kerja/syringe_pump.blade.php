                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left"> <b>Infusion Device Analyzer</b>
                        </td>
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" rowspan="3" align="left"><b>Flow Rate (mL/H)</b>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="2" rowspan="1" align="left"><b>Alarm Occlusion
                            (mmHg)</b></td>
                        <td><input name="pembacaan_standar_1" maxlength="4" size="4" type="text"
                            style="border: 0" placeholder="-"></td>
                        <td><input name="koreksi_1" maxlength="4" size="4" type="text" style="border: 0"
