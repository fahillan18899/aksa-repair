                ...
                <form action="{{ route('lembar_kerja.store') }}" class="form-inner"
                  ...
                  <table class="table table-hover table-bordered">
                    <tbody>
                      ...
                      <tr>
                        <td colspan=""><b>1</b></td>
                        <td><b><input name="parameter_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="parameter_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td colspan=""><b>2 </b></td>
                        <td><b><input name="range_normal_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="range_normal_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td colspan=""><b>3</b></td>
                        <td><b><input name="result_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="result_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
