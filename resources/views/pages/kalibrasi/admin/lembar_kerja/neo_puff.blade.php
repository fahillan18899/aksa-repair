<div role="tabpanel" class="tab-pane" id="neo_puff">
      ...
      <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
          ...
          <div class="panel-heading no-print">
            <h1>Lembar Kerja Pengujian dan Neo Puff</h1>
          </div>
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left"><b>Periksa tombol tombol</b></td>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="table-info" colspan="6" rowspan="" align="center"><b>Hasil Pengukuran
                            Pada Standar ( LPM )</b></td>
                        <td class="table-info" colspan="3" rowspan="" align="center"><b>Perhitungan</b></td>
                        <td class="table-info" colspan="17" rowspan="" align="center"><b>Perhitungan</b>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Veff</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>k</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>U 95</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>U 95 dg k=2</b></td>

                      </tr>

                      <tr>
                        <td class="table-info" colspan="" rowspan="3" align="center"><b>Flow (LPM)</b></td>
                        ...
                        <td><input name="hasil_pemeriksaan_fungsi_5" type="text" maxlength="4" size="4"
                            style="border: 0" placeholder="-"></td>
                        <td colspan="" rowspan="3"><input name="hasil_pemeriksaan_fungsi_5" type="text"
