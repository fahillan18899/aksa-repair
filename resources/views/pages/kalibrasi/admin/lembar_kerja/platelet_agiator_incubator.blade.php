<div role="tabpanel" class="tab-pane" id="platelet_agiator_incubator">
    ...
    <div class="col-sm-12">
      <div class="panel panel-default thumbnail">
        ...
        <div class="panel-heading no-print">
          <h1>Lembar Kerja Pengujian dan Kalibrasi Platelet Agiator Incubator</h1>
        </div>
            ...
            <div class="col-md-12 col-sm-12">
              <form action="{{ url('/kalibrasi/sphygmomanometer') }}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    <tr>
                      <td class="table-info" colspan=""  rowspan="2" align="center"><b>Setting pada UUT</b></td>
                      <td class="table-info" colspan=""  rowspan="2" align="center"><b>Posisi Sensor</b></td>
                      <td class="table-info" colspan="5"  rowspan=""align="center"><b>Perhitungan</b></td>
                      <td class="table-info" colspan="2"  rowspan=""align="center"><b>Terukur pd Std</b></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>t Max</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>t Min</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Diff</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Mid</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>K.std</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Max</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Min</b></td>
                    </tr>
                    <tr>
                        <td class="table-info" rowspan="8" colspan="" align="center"><b>109,0 °C</b></td>
                        <td class="table-info" rowspan="" colspan="" align="center"><b>t1</b></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                        <td class="table-info" rowspan="" colspan="" align="center"><b>t2</b></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                        <td class="table-info" rowspan="" colspan="" align="center"><b>t3</b></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                        <td class="table-info" rowspan="" colspan="" align="center"><b>t4</b></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                        <td class="table-info" rowspan="" colspan="" align="center"><b>t5</b></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                        <td class="table-info" rowspan="" colspan="" align="center"><b>t6</b></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                        <td class="table-info" rowspan="" colspan="" align="center"><b>t7</b></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                        <td class="table-info" rowspan="" colspan="2" align="center"><b>Indikator</b></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                        <td class="table-info" rowspan="" colspan="2" align="center"><b>Raungan</b></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
                        <td><input class="form-control" name="" type="text" placeholder="-"></td>
