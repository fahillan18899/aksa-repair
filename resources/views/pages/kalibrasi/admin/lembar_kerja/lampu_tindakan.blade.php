<div role="tabpanel" class="tab-pane" id="lampu_tindakan">
      ...
      <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
          ...
          <div class="panel-heading no-print">
            <h1>Lembar Kerja Pengujian dan Lampu Tindakan</h1>
          </div>
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><input name="no_label" type="date" style="border: 0" placeholder="-"></td>
                      </tr>
                      <tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="table-info" colspan="3" rowspan="" align="center"><b>Terbaca Pada
                            Kalibrator</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Ambang batas yang
                            dizinkan</b></td>
                      </tr>
                      <tr>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Maximum illuminance
                            (lux)</b></td>
                        ...
                        <td class="table-info" colspan="" rowspan="" align="center"><b>40.000-160.000
                            lux</b></td>
                      </tr>
