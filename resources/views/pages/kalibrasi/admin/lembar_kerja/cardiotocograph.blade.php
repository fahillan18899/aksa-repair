                ...
                <form action="{{ route('lembar_kerja.store') }}" class="form-inner"
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        <td class="table-info" colspan="1" align="left"><b>1</b></td>
                        <td class="table-info" colspan="1" align="left"><b> Kabel Power/Adaptor/Battery </b>
                        </td>
                  ...
                  <table class="table table-hover table-bordered">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><b><input name="frekuensi120_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="frekuensi120_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="frekuensi120_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td colspan=""><b>180 </b></td>
                        <td><b><input name="frekuensi180_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="frekuensi180_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="frekuensi180_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td colspan=""><b>240 </b></td>
                        <td><b><input name="frekuensi240_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="frekuensi240_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="frekuensi240_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                    </tbody>
                  </table>
