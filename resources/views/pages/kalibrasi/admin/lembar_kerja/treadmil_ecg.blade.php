<div role="tabpanel" class="tab-pane" id="treadmil_ecg">
    ...
    <div class="col-sm-12">
      <div class="panel panel-default thumbnail">
        ...
        <div class="panel-heading no-print">
          <h1>Lembar Kerja Pengujian dan Kalibrasi Treadmil ECG</h1>
        </div>
            ...
            <div class="col-md-12 col-sm-12">
              <form action="{{ url('/kalibrasi/sphygmomanometer') }}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="table-info" colspan="1" align="left">ECG Simulator</td>
                      <td><select name="" class="form-control" id="" style="border:0">
                          <option>-- Pilih ID Aset --</option>
                          dd
                          @foreach($alatUkur as $item)
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    <tr>
                      <td class="table-info" colspan="2"  rowspan="2" align="center"><b>Parameter</b></td>
                      <td class="table-info" colspan="2"  rowspan="" align="center"><b>Titik Ukur pada Alat</b></td>
                      <td class="table-info" colspan="6"  rowspan=""align="center"><b>Hasil Pengukuran pada Standart</b></td>
                      ...
                      <td class="table-info" colspan=""  rowspan="2"align="center"><b>Ambang batas</b></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Setting</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Penunjukan alat</b></td>
                      ...
                      <td class="table-info" rowspan="" colspan="" align="center"><b>IV</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>V</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>VI</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Std - Alat</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Deviasi</b></td>

                    </tr>
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b></b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>waktu</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b></b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>detik</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="5" colspan="" align="center"><b>1</b></td>
                      <td class="table-info" rowspan="5" colspan="2" align="center"><b>Kecepatan Putaran (km)</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    <tr>
                      ...
                      <td class="table-info" colspan=""  rowspan="" align="center"><b>Parameter</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="center"><b>Setting pada alat</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="center"><b> Pembacaan Pada Standar</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="center"><b> Terukur rata-rata pada standar</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="center"><b> Kesalahan</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="center"><b> Kesalahan Relatif (%)</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="center"><b> Kesalahan maksimal yg diijinkan</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="center"><b> Ketidakpastian Pengukuran</b></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="4" colspan="" align="center"><b>2</b></td>
                      <td class="table-info" rowspan="4" colspan="" align="center"><b>Heart Rate</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>30</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td class="table-info" rowspan="4" colspan="" align="center"><b>10%</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>± 1,14</b></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>60</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>120</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>180</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
