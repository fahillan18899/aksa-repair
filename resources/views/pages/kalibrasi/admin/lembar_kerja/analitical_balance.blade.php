<div role="tabpanel" class="tab-pane" id="analitical_balance">
    ...
    <div class="col-sm-12">
      <div class="panel panel-default thumbnail">
        ...
        <div class="panel-heading no-print">
          <h1>Lembar Kerja Pengujian dan Kalibrasi Analitical Balance</h1>
        </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <form action="{{ url('/kalibrasi/sphygmomanometer') }}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="table-info" colspan="1" align="left">Thermo Couple </td>
                      <td><select name="" class="form-control" id="" style="border:0">
                          <option>-- Pilih ID Aset --</option>
                          dd
                          @foreach($alatUkur as $item)
                ...
                <h4>Daya Ulang Pembacaan</h4>
                <h5>Beban : 50,00 g</h5>
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    <tr>
                      <td class="table-info" colspan=""  rowspan="" align="center"><b>No</b></td>
                      <td class="table-info" colspan=""  rowspan="" align="center"><b>z1 g</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="center"><b>m1 g</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="center"><b>r=m1-z1 g</b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>6</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>7</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>8</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>9</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    </tr>
                ...
                <h4>Penyimpangan Penunjukan</h4>
                <h5>Beban : 50,00 g</h5>
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    <tr>
                      <td class="table-info" colspan=""  rowspan="2" align="center"><b>No</b></td>
                      <td class="table-info" colspan=""  rowspan="2" align="center"><b>Massa (g)</b></td>
                      <td class="table-info" colspan="4"  rowspan=""align="center"><b>Penunjukan Standar (Kg)</b></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>z1</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>m1</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>m2</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>z2</b></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>6</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>70</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>7</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>100</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>8</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>160</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>10</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>200</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
