<div role="tabpanel" class="tab-pane" id="suction_pump_Cmhg">
    ...
    <div class="col-sm-12">
      <div class="panel panel-default thumbnail">
        ...
        <div class="panel-heading no-print">
          <h1>Lembar Kerja Pengujian dan Kalibrasi Suction Pump Cmhg</h1>
        </div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <form action="{{ url('/kalibrasi/sphygmomanometer') }}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                ...
                <h5>1. Akurasi Tekanan</h5>
                <h5>Tekanan max  -0,076 Kpa</h5>
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    <tr>
                      <td class="table-info" colspan=""  rowspan="" align="left"><b>Parameter</b></td>
                      <td class="table-info" colspan="" rowspan="" align="center"><b>SETTING</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="left"><b>Terbaca Pada Alat Kpa</b></td>
                      ...
                      <td class="table-info" colspan=""  rowspan=""align="left"><b>MEAN</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="left"><b>Stdv</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="left"><b>Koreksi</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="left"><b>Toleransi (mmHg)</b></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="5" colspan="" align="left"><b>Tekanan Naik</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                    <td class="table-info" rowspan="" colspan="" align="left"><b>MAX</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="5" colspan="" align="left"><b>Tekanan Turun</b></td>
                      <td class="table-info" rowspan="" colspan="" align="left"><b>MAX</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                ...
                <h3>Akurasi tekanan hisap maksimum </h3>
                <h4>Tekanan Max   -0,076 Kpa </h4>
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    <tr>
                      <td class="table-info" colspan=""  rowspan="" align="left"><b>Parameter</b></td>
                      ...
                      <td class="table-info" colspan=""  rowspan=""align="left"><b>DATA 1</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="left"><b>Koreksi</b></td>
                      <td class="table-info" colspan=""  rowspan=""align="left"><b>Toleransi</b></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="5" colspan="" align="left"><b>Tekanan Max</b></td>
                      <td class="table-info" rowspan="5" colspan="" align="left"><b>100%</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
