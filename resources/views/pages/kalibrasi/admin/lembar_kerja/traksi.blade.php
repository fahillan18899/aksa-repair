<div role="tabpanel" class="tab-pane" id="traksi">
    ...
    <div class="col-sm-12">
      <div class="panel panel-default thumbnail">
        ...
        <div class="panel-heading no-print">
          <h1>Lembar Kerja Pengujian dan Kalibrasi Traksi</h1>
        </div>
              ...
              <form action="{{ url('/kalibrasi/sphygmomanometer') }}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="table-info" colspan="1" align="left">Force Gauge</td>
                      <td><select name="" class="form-control" id="" style="border:0">
                          <option>-- Pilih ID Aset --</option>
                          dd
                          @foreach($alatUkur as $item)
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    <tr>
                      ...
                      <td class="table-info" colspan=""  rowspan="2"align="center"><b>Setting Pada Alat</b></td>
                      <td class="table-info" colspan="3"  rowspan=""align="center"><b> Pembacaan Pada Standar</b></td>
                      <td class="table-info" colspan=""  rowspan="2"align="center"><b>Terukur rata2 pada standar</b></td>
                      <td class="table-info" colspan=""  rowspan="2"align="center"><b>Kesalahan</b></td>
                      <td class="table-info" colspan=""  rowspan="2"align="center"><b>Kesalahan Relatif (%)</b></td>
                      <td class="table-info" colspan=""  rowspan="2"align="center"><b>Kesalahan maksimal yg diijinkan</b></td>
                      <td class="table-info" colspan=""  rowspan="2"align="center"><b>Ketidakpastian Pengukuran</b></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td class="table-info" rowspan="5" colspan="" align="center"><b>Massa (Kg)</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>10</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td class="table-info" rowspan="5" colspan="" align="center"><b>10%</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    </tr>
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>2</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>20</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      ...
                      <td class="table-info" rowspan="" colspan="" align="center"><b>40</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>5</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>50</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    ...
                    <tr>
                      <td class="table-info" rowspan="7" colspan="" align="center"><b>Timer</b></td>
                      <td class="table-info" rowspan="7" colspan="" align="center"><b>Menit</b></td>
                      <td class="table-info" rowspan="" colspan="2" align="center"><b>Penunjuk Alat</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Menit</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Detik</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>Mili Detik</b></td>

                    </tr>
                    <tr>
                      <td rowspan="3"><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>1</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>1</b></td>
                      <td class="table-info" rowspan="2" colspan="" align="center"><b>timer detik</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>300</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td class="table-info" rowspan="2" colspan="" align="center"><b>10 %</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                    </tr>
                    <tr>
                    <td class="table-info" rowspan="" colspan="" align="center"><b>2</b></td>
                      <td class="table-info" rowspan="" colspan="" align="center"><b>600</b></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
                      <td><input class="form-control" name="" type="text" placeholder="-"></td>
