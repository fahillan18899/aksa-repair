<div role="tabpanel" class="tab-pane" id="laminar_air">
      ...
      <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
          ...
          <div class="panel-heading no-print">
            <h1>Lembar Kerja Pengujian dan Kalibrasi Laminar Air Flow</h1>
          </div>
                ...
                <form action="{{ route('lembar_kerja.store') }}" class="form-inner"
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left"> <b>TSI Airflow Anemometer</b> </td>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left"> <b>Handled Particle Counter</b>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left"> <b>Smoke Generator</b> </td>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left"> <b>Sound Level</b> </td>
                        <td><input name="merek_7" type="text" style="border: 0" placeholder="-"></td>
                        <td><input name="tipe_7" type="text" style="border: 0" placeholder="-"></td>
                        <td><input name="no_seri_7" type="text" style="border: 0" placeholder="-"></td>
                        <td><input name="tertelusur_7" type="text" style="border: 0" placeholder="-"></td>
                      </tr>
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        <td class="table-info" colspan="1" align="left"><b>3</b></td>
                        <td class="table-info" colspan="1" align="left"><b>aksesori</b></td>
                  ...
                  <h4>1. Aliran Udara</h4>
                  <h5>a.Kecepatan DownFlow</h5>

                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      <tr>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Kiri ke kanan /
                            Depan-belakang (cm)</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>15</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>30</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>45</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>60</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>75</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>90</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>105</b></td>
                      </tr>
                      <tr>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>15</b></td>
                      ...
                      <tr>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>29</b></td>
                        <td><input name="BIL_2" maxlength="4" size="4" type="text" style="border: 0"
                            placeholder="-">
                        </td>
                        <td><input name="BIL_2" maxlength="4" size="4" type="text" style="border: 0"
                      ...
                      <tr>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>43</b></td>
                        <td><input name="BIL_2" maxlength="4" size="4" type="text" style="border: 0"
                            placeholder="-">
                        </td>
                        <td><input name="BIL_2" maxlength="4" size="4" type="text" style="border: 0"
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      <tr>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Left to Right
                            (cm)</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>14,1</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>28,2</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>42,3</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>56,4</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>70,5</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>84,6</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>98,7</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>112,8</b></td>
                      </tr>
                      <tr>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>3,8</b></td>
                        <td><input name="BIL_2" maxlength="4" size="4" type="text" style="border: 0"
                            placeholder="-">
                        </td>
                        <td><input name="BIL_2" maxlength="4" size="4" type="text" style="border: 0"
                  ...
                  <h4>2. Pengujian perhitungan Partikel udara</h4>
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      <tr>
                        <td><input name="BIL_2" maxlength="4" size="4" type="text" style="border: 0"
                  ...
                  <h4>3. Itensitas Cahaya</h4>
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      <tr>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Parameter Ukur</b>
                        </td>
                        <td class="table-info" colspan="3" rowspan="" align="center"><b>Terbaca Pada
                            Kalibrator</b></td>
                        <td class="table-info" colspan="2" rowspan="" align="center"><b>Ambang batas yang
                            dizinkan ></b></td>
                      </tr>
                      <tr>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Itensitas Cahaya</b>
                        </td>
                        <td><input name="BIL_2" maxlength="4" size="4" type="text" style="border: 0"
                            placeholder="-">
                        </td>
                        ...
                        <td class="table-info" colspan="" rowspan="" align="center"><b>750</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Lux</b></td>
                      </tr>
                    </tbody>
                  </table>
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      <tr>
                        <td class="table-info" colspan="3" rowspan="" align="center"><b>Hasil Pengukuran
                            Pada Standar </b></td>
                        <td class="table-info" colspan="3" rowspan="" align="center"><b>Perhitungan</b></td>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Nilai Max</b></td>
                        ...
                        <td class="table-info" colspan="" rowspan="" align="center"><b>ci</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Uc</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>U 95 dengan k=2</b>
                        </td>
                      </tr>
                      <tr>
                        <td><input name="BIL_2" maxlength="4" size="4" type="text" style="border: 0"
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="" rowspan="" align="center"><b>65</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>dBA</b></td>
                      </tr>
                    </tbody>
                  </table>
