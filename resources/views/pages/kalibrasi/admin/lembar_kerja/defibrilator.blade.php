                    ...
                    <table class="table table-hover table-bordered">
                      <tbody>
                        ...
                        <tr>
                          <td rowspan="8"><b>Energi (joule) </b></td>
                          <td colspan=""><b>300 </b></td>
                          <td><b><input name="energi300j_1" type="text" style="border: 0" placeholder="-"></b>
                          </td>
                          <td><b><input name="energi300j_2" type="text" style="border: 0" placeholder="-"></b>
                          </td>
                          <td><b><input name="energi300j_3" type="text" style="border: 0" placeholder="-"></b>
                          </td>
                        </tr>
                      </tbody>
                    </table>
