                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left"><b>Kabel Helical Aplikator MWD</b>
                        </td>
                        <td><input name="hasil_pemeriksaan_fisik_12" type="text" style="border: 0"
                            placeholder="-"></td>
                        <td><input name="hasil_pemeriksaan_fungsi_12" type="text" style="border: 0"
                  ...
                  <table class="table table-hover table-bordered">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><b><input name="" size="8" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="" size="4" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="" size="4" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="" size="4" type="text" style="border: 0" placeholder="-"></b>
                        ...
                        <td rowspan="4"><b><input name="" size="8" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="" size="8" type="text" style="border: 0" placeholder="-"></b>
                        </td>
