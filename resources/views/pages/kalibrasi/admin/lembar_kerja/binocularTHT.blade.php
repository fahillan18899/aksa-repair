<div role="tabpanel" class="tab-pane" id="binocularTHT">
      ...
      <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
          ...
          <div class="panel-heading no-print">
            <h1>Lembar Kerja Pengujian dan Kalibrasi Microscope Binocular THT</h1>
          </div>
              ...
              <div class="col-md-10 col-sm-12">
                <form action="{{ route('lembar_kerja.store') }}" class="form-inner"
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left">Kaca Preparat</td>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left">Rermohygrometer</td>
                        <td><input name="merek_1" type="text" style="border: 0" placeholder="-"></td>
                        <td><input name="tipe_1" type="text" style="border: 0" placeholder="-"></td>
                        <td><input name="no_seri_1" type="text" style="border: 0" placeholder="-"></td>
                        <td><input name="tertelusur_1" type="text" style="border: 0" placeholder="-"></td>
                  ...
                  <table class="table table-hover table-bordered" style="width:100%">
                    <tbody>
                      <tr>
                        <td class="table-info" colspan="1" align="center"><b>Objektif</b></td>
                        <td class="table-info" colspan="1" align="center"><b>Okuler micrometer Kiri</b></td>
                        <td class="table-info" colspan="1" align="center"><b>Okuler micrometer</b></td>
                        <td class="table-info" colspan="1" align="center"><b>Kanan Stage Micrometer</b></td>
                        <td class="table-info" colspan="1" align="center"><b>1 : okuler</b></td>
                      </tr>
                      <tr>
                        <td class="table-info"><b>4x</b></td>
                        <td><input name="hasil_pemeriksaan_fungsi_5" type="text" style="border: 0"
                            placeholder="-"></td>
                        <td><input name="hasil_pemeriksaan_fungsi_5" type="text" style="border: 0"
                            placeholder="-"></td>
                      ...
                      <tr>
                        <td class="table-info"><b>10x</b></td>
                        <td><input name="hasil_pemeriksaan_fungsi_5" type="text" style="border: 0"
                            placeholder="-"></td>
                        <td><input name="hasil_pemeriksaan_fungsi_5" type="text" style="border: 0"
                            placeholder="-"></td>
                      ...
                      <tr>
                        <td class="table-info"><b>40x</b></td>
                        <td><input name="hasil_pemeriksaan_fungsi_5" type="text" style="border: 0"
                            placeholder="-"></td>
                        <td><input name="hasil_pemeriksaan_fungsi_5" type="text" style="border: 0"
                            placeholder="-"></td>
                      ...
                      <tr>
                        <td class="table-info"><b>100x</b></td>
                        <td><input name="hasil_pemeriksaan_fungsi_5" type="text" style="border: 0"
                            placeholder="-"></td>
                        <td><input name="hasil_pemeriksaan_fungsi_5" type="text" style="border: 0"
                            placeholder="-"></td>
