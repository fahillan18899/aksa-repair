<div role="tabpanel" class="tab-pane" id="heatlamp">
    ...
    <div class="col-sm-12">
      <div class="panel panel-default thumbnail">
        ...
        <div class="panel-heading no-print">
          <h1>Lembar Kerja Pengujian dan Kalibrasi Heat Lamp</h1>
        </div>
            ...
            <div class="col-md-12 col-sm-12">
              <form action="{{ url('/kalibrasi/sphygmomanometer') }}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    <tr>
                      <td class="table-info" align="left"><b>Parameter Ukur</b></td>
                      <td class="table-info" colspan="3" align="center"><b>Terbaca Pada Kalibrator</b> </td>
                      <td class="table-inf " align="left"><b>Ambang batas yang dizinkan</b></td>
                    </tr>
                    <tr>
                      <td>Maximum illuminance (lux)</td>
                      <td><input class="form-control input-number" name="no_label" type="text" style="border: 0" placeholder="-"></td>
                      <td><input class="form-control input-number" name="no_label" type="text" style="border: 0" placeholder="-"></td>
                      <td><input class="form-control input-number" name="no_label" type="text" style="border: 0" placeholder="-"></td>
