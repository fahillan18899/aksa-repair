<div role="tabpanel" class="tab-pane active" id="Ultrasonograph">
    ...
    <div class="col-sm-12">
      <div class="panel panel-default thumbnail">
        ...
        <div class="panel-heading no-print">
          <h1>Lembar Kerja Pengujian dan Kalibrasi Ultrasonograph</h1>
        </div>
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="table-info" colspan="1" align="left">Ultrasound Phantom</td>
                      <td><select name="" class="form-control" style="border:0">
                          <option>-- Pilih ID Aset --</option>
                          dd
                          @foreach($alatUkur as $item)
                ...
                <table class="table table-hover table-bordered" style=" width:100%">
                  <tbody>
                    <tr>
                      ...
                      <td rowspan="2">Setting Pada Alat</td>
                      <td rowspan="2">Kedalaman</td>
                      <td colspan="3"> Pembacaan Pada Alat</td>
                    </tr>
                    <tr>
                      <td>I</td>
                      <td>II</td>
                    ...
                    <tr>
                      <td rowspan="4">Jarak (mm)</td>
                      <td rowspan="2">Vertikal </td>
                      <td>10 </td>
                      <td>40-50 </td>
                      <td><input class="form-control input-number" name="kelembapan_sesudah" type="text" style="border: 0" placeholder="-">
                      <td><input class="form-control input-number" name="kelembapan_sesudah" type="text" style="border: 0" placeholder="-">
