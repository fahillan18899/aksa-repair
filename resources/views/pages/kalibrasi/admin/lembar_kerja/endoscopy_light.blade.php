<div role="tabpanel" class="tab-pane" id="endoscopy_light">
    ...
    <div class="col-sm-12">
      <div class="panel panel-default thumbnail">
        ...
        <div class="panel-heading no-print">
          <h1>Lembar Kerja Pengujian dan Kalibrasi Endoscopy Light</h1>
        </div>
                ...
                <table class="table table-hover table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th colspan="3">Terbaca Pada Kalibrator </th>
                      <th>Ambang batas yang dizinkan </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
