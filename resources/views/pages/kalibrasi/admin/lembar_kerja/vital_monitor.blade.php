                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left"> Thermohygrometer, Merk: Sanfix ,
                          Model/Type: TH-303, S/N 1409688 (Tertelusur ke LK-031-IDN)</td>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left">NIBP Simulator, Merk: Accupulse,
                          Model/Type: -, S/N HH12080322 (-)</td>
                      ...
                      <tr>
                        ...
                        <td class="table-info" colspan="1" align="left">SPO2 Simulator, Merk: Fluke ,
                          Model/Type: Index 2, S/N 9859005 (-)</td>
                  ...
                  <table class="table table-hover table-bordered">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><b>98 </b></td>
                        <td><b><input name="saturasi_oksigen98_1" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen98_2" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen98_3" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>93 </b></td>
                        <td><b><input name="saturasi_oksigen93_1" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen93_2" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen93_3" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>92 </b></td>
                        <td><b><input name="saturasi_oksigen92_1" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen92_2" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen92_3" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>85 </b></td>
                        <td><b><input name="saturasi_oksigen85_1" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen85_2" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen85_3" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>30 </b></td>
                        <td><b><input name="saturasi_oksigen30_1" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen30_2" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen30_3" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>90 </b></td>
                        <td><b><input name="saturasi_oksigen90_1" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen90_2" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen90_3" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>70 </b></td>
                        <td><b><input name="saturasi_oksigen70_1" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen70_2" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen70_3" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>88 </b></td>
                        <td><b><input name="saturasi_oksigen88_1" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen88_2" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                        <td><b><input name="saturasi_oksigen88_3" type="text" style="border: 0"
                              placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><b>30 </b></td>
                        <td><b><input name="respirasi30_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi30_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi30_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>60 </b></td>
                        <td><b><input name="respirasi60_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi60_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi60_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>80 </b></td>
                        <td><b><input name="respirasi80_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi80_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi80_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>120 </b></td>
                        <td><b><input name="respirasi120_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi120_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi120_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>180 </b></td>
                        <td><b><input name="respirasi180_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi180_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi180_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>240 </b></td>
                        <td><b><input name="respirasi240_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi240_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="respirasi240_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                  ...
                  <table class="table table-hover table-bordered">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><b>30 </b></td>
                        <td><b><input name="heart_rate30_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="heart_rate30_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="heart_rate30_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>60 </b></td>
                        <td><b><input name="heart_rate60_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="heart_rate60_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="heart_rate60_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>120 </b></td>
                        <td><b><input name="heart_rate120_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="heart_rate120_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="heart_rate120_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>180 </b></td>
                        <td><b><input name="heart_rate180_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="heart_rate180_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="heart_rate180_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>240 </b></td>
                        <td><b><input name="heart_rate240_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="heart_rate240_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="heart_rate240_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                    </tbody>
                  </table>
                  <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><b>Diastole </b></td>
                        <td><b>100 </b></td>
                        <td><b><input name="diastole100_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="diastole100_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="diastole100_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                    </tbody>
                    <tbody>
                      ...
                      <tr>
                        <td><b>mean </b></td>
                        <td><b>166 </b></td>
                        <td><b><input name="mean166_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="mean166_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="mean166_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                        <td><b>Diastole </b></td>
                        <td><b>150 </b></td>
                        <td><b><input name="diastole150_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="diastole150_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="diastole150_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                    </tbody>
                    <tbody>
                      ...
                      <tr>
                        <td><b>Diastole </b></td>
                        <td><b>195 </b></td>
                        <td><b><input name="diastole195_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="diastole195_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="diastole195_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                    </tbody>
                    <tbody>
