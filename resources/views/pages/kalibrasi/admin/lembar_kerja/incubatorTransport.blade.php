                ...
                <form action="{{ route('lembar_kerja.store') }}" class="form-inner"
                  ...
                  <table class="table table-hover table-bordered">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><b><input name="frekuensi40_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="frekuensi40_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      ...
                      <tr>
                        ...
                        <td><b><input name="frekuensi60_1" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="frekuensi60_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="frekuensi60_3" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                      </tr>
                      <tr>
                  ...
                  <table class="table table-hover table-bordered">
                    <tbody>
                      ...
                      <tr>
                        <td rowspan=""><b>"Akurasi temperatur Kulit Bayi dengan temperatur kontrol ( ºC)"
                          </b></td>
                        <td><b><input name="frekuensi40_2" type="text" style="border: 0" placeholder="-"></b>
                        </td>
                        <td><b><input name="frekuensi40_3" type="text" style="border: 0" placeholder="-"></b>
