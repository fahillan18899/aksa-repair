<div role="tabpanel" class="tab-pane" id="nebulizer">
      ...
      <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
          ...
          <div class="panel-heading no-print">
            <h1>Lembar Kerja Pengujian dan Kalibrasi Nebulizer</h1>
          </div>
                ...
                <form action="{{ route('lembar_kerja.store') }}" class="form-inner"
                  ...
                  <table class="table table-hover table-bordered" style=" width:100%">
                    <tbody>
                      ...
                      <tr>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>Flow O2</b></td>
                        <td class="table-info" colspan="" rowspan="" align="center"><b>6.00</b></td>
