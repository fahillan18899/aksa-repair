                  ...
                  <table class="table-striped" width="100%">
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center" colspan="3"><input name="rs[1]" id="" type="text" class="form-control" value="{{ $item->instansi }}" readonly></td>
                      </tr>
                      <tr>
                  ...
                  <table class="table-striped" width="100%">
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center" colspan="3"><input name="alat[1]" id="" type="text" class="form-control" value="{{ $item->nama_alat }}" readonly></td>
                      </tr>
                      <tr>
                        <td class="text-center" width="20%"><b>Merk</b></td>
                        <td class="text-center"><input name="alat[2]" id="" type="text" class="form-control" value="{{ $item->merek }}" readonly></td>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><input name="alat[4]" id="" type="text" class="form-control" value="{{ $item->type }}" readonly></td>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><input name="alat[6]" id="" type="text" class="form-control" value="{{ $item->no_seri }}" readonly></td>
