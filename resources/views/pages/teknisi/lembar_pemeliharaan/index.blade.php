                            ...
                            <div class="col-md-12 col-sm-12">
                                <div id="app">
                                    <div class="preview-container">
                                        <video id="preview_lembar_teknisi"></video>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="id_aset" type="text" class="form-control" id="id_ase1t"
                                                placeholder="ID Aset" onkeyup="autofillPemeliharaTeknisi()">
                                        </div>
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a data-toggle="tooltip" data-placement="right" title="Cetak"
                                                href="/dashboard_teknisi/lembar_pemeliharaan/cetak_pemeliharaan/{{ $item->id_ppm }}"
