    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
          ...
          <div class="panel-heading no-print" id="form3">
          ...
          <div class="panel-body panel-form">
            <div class="row">
              <div class="col-md-9 col-sm-12">
                <form action="{{ url('dashboard_teknisi/lembar_pemeliharaan') }}" class="form-inner"
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                      <input name="jumlah_harga" type="text" class="form-control" id="jumlah_harga" placeholder="Terisi Otomatis" readonly>
                    </div>
                  </div>
              ...
              <table class="datatable table table-striped table-bordered" id="scollDatatable" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $item->ruangan }}</td>
                    <td>
                      <a data-toggle="tooltip" data-placement="right" title="View Detail" href="/dashboard_teknisi/lembar_pemeliharaan/cetak/{{ $item->id_ppm }}" class="btn btn-xs btn-primary" target="_blank"><i class="fa fa-eye"></i></a>
                    </td>
                  </tr>
                  @empty
                  @endforelse
...
<script>
  ...
  $(document).ready(function() {
    $('#id_ase1t').on('click', function() {
      ...
      fetch(`autofill_pelihara/${encodeURIComponent(idAset)}`)
