                        ...
                        <div class="panel-body panel-form">
                            <div class="row">
                                <div class="col-md-9 col-sm-12">
                                    <form action="{{ url('/dashboard/ppm/gedung') }}" class="form-inner"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <input name="id_gedung" type="text" class="form-control" id="id_gedung"
                                                    placeholder="id gedung" value="{{ $kodeGedung }}" readonly />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <input name="nama_gedung" type="text" class="form-control"
                                                    id="nama_gedung" placeholder="Nama Gedung " required />
                                            </div>
                                        </div>
                                            ...
                                            @forelse ($gedung as $item)
                                                <tr>
                                                    ...
                                                    <td scope="row" style=" display: flex; flex-direction: row; ">
                                                        <a href="{{ route('gedung.edit', $item->id_gedung) }}"
                                                            class="btn btn-xs btn-primary"><i class="fa fa-edit"
                                                                data-toggle="tooltip" data-placement="top"
                                                                title="Edit"></i></a>
                                                        <form action="{{ route('gedung.destroy', $item->id_gedung) }}"
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default thumbnail">
                        ...
                        <div class="panel-body panel-form">
                            <div class="row">
                                <div class="col-md-9 col-sm-12">
                                    <form action="{{ url('/dashboard/ppm/alat') }}" class="form-inner"
                                        enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <input name="id_alat" type="text" class="form-control" id="id_alat"
                                                    placeholder="id alat" value="{{ $kodeAlat }}" readonly />
                                            </div>
                                        </div>
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default thumbnail">
                        ...
                        <div class="panel-body panel-form">
                            <div class="row">
                                <div class="col-md-9 col-sm-12">
                                    <form action="{{ url('/dashboard/ppm/teknisi') }}" class="form-inner"
                                        enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <input name="id_teknisi" type="text" class="form-control"
                                                    id="id_teknisi" placeholder="id teknisi" value="{{ $kodeTeknisi }}"
                                                    readonly />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9">
                                                <input name="nama_teknisi" type="text" class="form-control"
                                                    id="nama_teknisi" placeholder="Nama Teknisi" />
                                            </div>
                                        </div>
                            ...
                            <tbody>
                                @forelse ($teknisi as $item)
                                    <tr>
                                        ...
                                        <td scope="row">
                                            <a href="{{ route('teknisi.edit', $item->id_teknisi) }}"
                                                class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="top"
                                                title="Edit"><i class="fa fa-edit"></i></a>

                                            <form action="{{ route('teknisi.destroy', $item->id_teknisi) }}"
                                                method="POST" style="display: inline">
                                                @csrf @method('delete')
                                                <button class="btn btn-danger btn-xs" data-toggle="tooltip"
                                                    data-placement="top" title="Hapus">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default thumbnail">
                        ...
                        <div class="panel-body panel-form">
                            <div class="row">
                                <div class="col-md-9 col-sm-12">
                                    <form action="{{ url('/dashboard/ppm/ruangan') }}" class="form-inner"
                                        enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                        @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-xs-9" readonly>
                                                <input name="id_ruangan" type="text" class="form-control"
                                                    id="id_ruangan" placeholder="id ruangan" value="{{ $kodeLokasi }}"
                                                    readonly />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="ruangan_alat" class="col-xs-3 col-form-label">Ruangan Alat
                                                <i class="text-danger">*</i></label>
                                            <div class="col-xs-9">
                                                <input name="ruangan_alat" type="text" class="form-control"
                                                    id="ruangan_alat" placeholder="Ruangan Alat" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="kepala_ruangan" class="col-xs-3 col-form-label">Kepala Ruangan<i
