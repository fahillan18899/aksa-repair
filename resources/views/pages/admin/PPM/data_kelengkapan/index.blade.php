        ...
        <div class="col-sm-12">
          ...
          <div class="panel panel-default thumbnail">
            <div class="panel-heading no-print">
              <div class="btn-group">
                <a class="btn btn-primary" onclick="hidden1()">
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="panel panel-default thumbnail">
            <div class="panel-heading no-print">
              <div class="btn-group">
                <a class="btn btn-primary" onclick="hidden2()">
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="panel panel-default thumbnail">
            <div class="panel-heading no-print">
              <div class="btn-group">
                <a class="btn btn-primary" onclick="hidden3()">
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="panel panel-default thumbnail">
          <div class="panel-heading no-print">
            <div class="btn-group">
              <a class="btn btn-primary" onclick="hidden4()">
