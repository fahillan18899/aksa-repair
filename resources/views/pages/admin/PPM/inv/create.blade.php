                ...
                <div class="col-md-9 col-sm-12">
                  <form action="{{route('inventaris.store')}}" class="form-inner" enctype="multipart/form-data" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <input name="nama_alat" id="nama_alat" type="text" class="form-control input-rounded" autocomplete="off" style="text-transform: uppercase" oninput="this.value.toUpperCase()" required>
                      ...
                      <div class="form-group">
                        ...
                        <input name="lokasi" id="lokasi" type="text" class="form-control input-rounded" style="text-transform: uppercase" oninput="this.value.toUpperCase()" required>
                      </div>
