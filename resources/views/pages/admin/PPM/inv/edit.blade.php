            ...
            <div class="panel-body panel-form">
              <div class="row">
                <div class="col-md-9 col-sm-12">
                  <form action="{{route('ppm.inventaris.update', $item->id)}}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
                    @method('PUT')
                      ...
                      <div class="form-group">
                          ...
                          <input name="jadwal" id="jadwal" type="date" class="form-control input-rounded" value="{{ $item->jadwal }}" required>
                      </div>
