                        ...
                        <div class="row">
                            <div class="col-md-9 col-sm-12">
                                <form action="{{ url('/dashboard/ppm/aset_teregistrasi') }}" class="form-inner"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="suku_cadang" type="text" class="form-control"
                                                id="nama_sukucadang1" placeholder="Nama Sukucadang">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="harga_satuan" class="col-xs-3 col-form-label">Harga Satuan
                                        </label>
                                        <div class="col-xs-9">
                                            <input name="harga_satuan" type="text" class="form-control"
                                                id="harga_satuan1" placeholder="Harga Satuan">
                                        </div>
                                    </div>

                                    <div class="form-group row">
                                        <label for="jumlah_harga" class="col-xs-3 col-form-label">Jumlah Harga
                                        </label>
                                        <div class="col-xs-9">
                                            <input name="jumlah_harga" type="text" class="form-control"
                                                id="jumlah_harga1" placeholder="Jumlah Harga">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-9 col-sm-12">
                                <form action="{{ url('/dashboard/ppm/tambah_pengiriman') }}" class="form-inner"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="id_perbaikan_reg" type="text" class="form-control"
                                                id="Perbaikan_reg" placeholder="Id Perbaikan"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="tanggal_perbaikan_reg" type="text" class="form-control"
                                                id="Tanggal_Perbaikan_reg1" placeholder="Tanggal Perbaikan" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="id_aset_reg" type="text" class="form-control"
                                                id="Id_Aset_reg1" placeholder="Id Aset" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="nama_alat_reg" type="text" class="form-control"
                                                id="Nama_Alat_reg1" placeholder="Nama Alat" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="merek_alat_reg" type="text" class="form-control"
                                                id="Merek_Alat_reg1" placeholder="Merek Alat" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="type_alat_reg" type="text" class="form-control"
                                                id="Type_Alat_reg1" placeholder="Type Alat" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="seri_number_reg" type="text" class="form-control"
                                                id="Seri_Number_reg1" placeholder="Seri Number" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="lokasi_alat_reg" type="text" class="form-control"
                                                id="Lokasi_Alat_reg1" placeholder="Lokasi Alat" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="pelapor_reg" type="text" class="form-control"
                                                id="Pelapor_reg1" placeholder="Pelapor" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="teknisi_1_reg" type="text" class="form-control"
                                                id="Teknisi_1_reg1" placeholder="Teknisi 1" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="teknisi_2_reg" type="text" class="form-control"
                                                id="Teknisi_2_reg1" placeholder="Teknisi 2" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="teknisi_3_reg" type="text" class="form-control"
                                                id="Teknisi_3_reg1" placeholder="Teknisi 3" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="suku_cadang" type="text" class="form-control"
                                                id="nama_sukucadang" placeholder="Nama Sukucadang" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="harga_satuan" type="text" class="form-control"
                                                id="harga_satuan" placeholder="Harga Satuan" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="jumlah_harga" type="text" class="form-control"
                                                id="jumlah_harga" placeholder="Jumlah Harga" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="keterangan_kondisi_alat_reg" type="text"
                                                ...
                                                placeholder="Keterangan Kondisi Alat" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="ka_instalasi_reg" type="text" class="form-control"
                                                id="KA_Instalasi_reg1" placeholder="Kepala Ruangan" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="nama_rekan_reg" type="text" class="form-control"
                                                id="Nama_Rekan_reg" placeholder="Nama Rekan">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="alamat_rekan_reg" type="text" class="form-control"
                                                id="Alamat_Rekan_reg" placeholder="Alamat Rekan">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="teknisi_rekanan_reg" type="text" class="form-control"
                                                id="Teknisi_Rekanan_reg" placeholder="Teknisi Rekanan">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="telp_teknisi_rekanan_reg" type="text"
                                                ...
                                                placeholder="Telp_Teknisi_Rekanan_reg">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-9 col-sm-12">
                                <form action="{{ url('/dashboard/ppm/tambah_pengembalian') }}" class="form-inner"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="id_perbaikan_reg" type="text" class="form-control"
                                                id="id_perbaikan_reg2" placeholder="id perbaikan" value=""
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="Id_Aset_reg" type="text" class="form-control"
                                                id="Id_Aset_reg2" placeholder="Id Aset" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="nama_alat_reg" type="text" class="form-control"
                                                id="nama_alat_reg2" placeholder="nama alat" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="tanggal_perbaikan_reg" type="text" class="form-control"
                                                id="tanggal_perbaikan_reg2" placeholder="tanggal perbaikan"
                                                value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="merek_reg" type="text" class="form-control"
                                                id="merek_reg2" placeholder="merek" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="tipe_reg" type="text" class="form-control"
                                                id="tipe_reg2" placeholder="Type" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="serial_number_reg" type="text" class="form-control"
                                                id="serial_number_reg2" placeholder="serial number" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="pelapor_reg" type="text" class="form-control"
                                                id="pelapor_reg2" placeholder="Pelapor" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="lokasi_alat_reg" type="text" class="form-control"
                                                id="lokasi_alat_reg2" placeholder="lokasi alat" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="keterangan_reg" type="text" class="form-control"
                                                id="keterangan_reg2" placeholder="keterangan" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="penerima_reg" type="text" class="form-control"
                                                id="penerima_reg2" placeholder="penerima" value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="harga_perbaikan_reg" type="text" class="form-control"
                                                id="harga_perbaikan_reg2" placeholder="harga perbaikan"
                                                value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="teknisi1_reg" type="text" class="form-control"
                                                id="teknisi1_reg2" placeholder="Teknisi 1" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="teknisi2_reg" type="text" class="form-control"
                                                id="teknisi2_reg2" placeholder="Teknisi 2" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="teknisi3_reg" type="text" class="form-control"
                                                id="teknisi3_reg2" placeholder="Teknisi 3" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="ka_instalasi_reg" type="text" class="form-control"
                                                id="ka_instalasi_reg2" placeholder="Kepala Ruangan" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="suku_cadang" type="text" class="form-control"
                                                id="nama_sukucadang2" placeholder="Nama Sukucadang" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="harga_satuan" type="text" class="form-control"
                                                id="harga_satuan2" placeholder="Harga Satuan" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="jumlah_harga" type="text" class="form-control"
                                                id="jumlah_harga2" placeholder="Jumlah Harga" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="penyebab_kerusakan_reg" type="text" class="form-control"
                                                id="penyebab_kerusakan_reg2" placeholder="Penyebab Kerusakan"
                                                value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="solusi_perbaikan_reg"
                                            class="col-xs-3 col-form-label">Solusi_Perbaikan </label>
                                        <div class="col-xs-9">
                                            <input name="solusi_perbaikan_reg" type="text" class="form-control"
                                                id="solusi_perbaikan_reg2" placeholder="Solusi_Perbaikan"
                                                value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="penguji_suku_cadang_reg" type="text" class="form-control"
                                                id="penguji_suku_cadang_reg2" placeholder="Penguji Suku Cadang"
                                                value="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="hasil_verifikasi_reg" type="text" class="form-control"
                                                id="hasil_verifikasi_reg2" placeholder="Hasil_Verifikasi"
                                                value="">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-9 col-sm-12">
                                <form action="{{ url('/dashboard/ppm/tambah_penghapusan') }}" class="form-inner"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="id_perbaikan_reg" type="text" class="form-control"
                                                id="Id_Perbaikan_reg3" placeholder="Id Perbaikan"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="nama_alat_reg" type="text" class="form-control"
                                                id="Nama_Alat_reg3" placeholder="Nama Alat" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="merek_alat_reg" type="text" class="form-control"
                                                id="Merek_Alat_reg3" placeholder="Merek Alat" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="type_alat_reg" type="text" class="form-control"
                                                id="Type_Alat_reg3" placeholder="Type Alat" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="serial_number_reg" type="text" class="form-control"
                                                id="Serial_Number_reg3" placeholder="Serial Number" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="lokasi_alat_reg" type="text" class="form-control"
                                                id="Lokasi_Alat_reg3" placeholder="Lokasi Alat" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="pelapor_reg" type="text" class="form-control"
                                                id="Pelapor_reg3" placeholder="Pelapor" value="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="teknisi_1_reg" type="text" class="form-control"
                                                id="Teknisi_1_reg3" placeholder="Teknisi 1" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="teknisi_2_reg" type="text" class="form-control"
                                                id="Teknisi_2_reg3" placeholder="Teknisi 2" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="teknisi_3_reg" type="text" class="form-control"
                                                id="Teknisi_3_reg3" placeholder="Teknisi 3" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="suku_cadang" type="text" class="form-control"
                                                id="nama_sukucadang3" placeholder="Nama Sukucadang" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="volume" type="text" class="form-control"
                                                id="volume3" placeholder="Volume" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="harga_satuan" type="text" class="form-control"
                                                id="harga_satuan3" placeholder="Harga Satuan" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="jumlah_harga" type="text" class="form-control"
                                                id="jumlah_harga3" placeholder="Jumlah Harga" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="ka_instalasi_reg" type="text" class="form-control"
                                                id="KA_Instalasi_reg3" placeholder="Kepala Ruangan" value=""
                                                readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-9">
                                            <input name="keterangan_pengguna_reg" type="text"
                                                ...
                                                placeholder="Keterangan Pengguna" value="">
                                        </div>
                                    </div>
