              ...
              <div class="col-md-9 col-sm-12">
                <form action="{{ route('update_perbaikan.update' ,$item->id_perbaikan_reg) }}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                      <input name="Nama_Alat_reg" type="text" class="form-control" id="Nama_Alat_reg" placeholder="Nama Alat" value="<?php echo $item['nama_alat_reg'] ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                      <input name="Lokasi_Alat_reg" type="text" class="form-control" id="Lokasi_Alat_reg" placeholder="Lokasi Alat" value="<?php echo $item['lokasi_alat_reg'] ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                      <input name="Ka_Instalasi_reg" type="text" class="form-control" id="Ka_Instalasi_reg" placeholder="Ka Instalasi" value="<?php echo $item['ka_instalasi_reg'] ?>">
                    </div>
                  </div>
