          ...
          <div class="card" id="PrintMe">
            ...
            <!-- TABLE -->
             <table class="table table-striped table-bordered" style="width: 100%; margin-top: 20px; margin-bottom: 20px">
              <thead class="table-light">
                <tr>
                  <th class="text-center" colspan="2" scope="col">DATA PENGEMBALIAN ALAT</th>
                </tr>
              </thead>
              <tbody>
                @php
                $data = [
                  ...
                  "PELAPOR" => "pelapor_reg",
                  "TEKNISI" => "teknisi1_reg",
                  "KETERANGAN" => "penyebab_kerusakan_reg",
                  "PENERIMA ALAT" => "penerima_reg",
                  "TANGGAL PENGEMBALIAN" => "tanggal_pengembalian_reg",
            ...
            <table class="table table-striped table-bordered" style="width:100%;">
              ...
              <tbody>
                ...
                <tr>
                  <td align="center">{{ $item->ka_isntalasi_reg ?? "-" }}</td>
