        ...
        <div class="panel panel-default thumbnail">
          ...
          <div class="card" id="PrintMe">
            ...
            <!-- TABLE -->
             <table class="table table-striped table-bordered" style="width: 100%; margin-top: 20px; margin-bottom: 20px">
              <thead class="table-light">
                <tr>
                  <th class="text-center" colspan="2" scope="col">DATA PENGIRIMAN ALAT</th>
                </tr>
              </thead>
              <tbody>
                @php
                $data = [
                  ...
                  "TYPE" => "type_alat_reg",
                  "SERIAL NUMBER" => "seri_number_reg",
                  "LOKASI" => "lokasi_alat_reg",
                  "TANGGAL PERBAIKAN" => "tanggal_perbaikan_reg",
                  "TANGGAL PENGIRIMAN" => "tanggal_pengiriman_reg",
                  ];
                @endphp
                ...
                @endforeach
                <tr>
                  <td class="text-center" width="50%"><b>WAKTU PENGIRIMAN</b></td>
                  <td><?php date_default_timezone_set('Asia/Jakarta'); echo date('h:i:s a'); ?></td>
                </tr>
              </tbody>
             </table>
            <!-- TABLE -->
            ...
            <table class="table table-striped table-bordered" style="width:100%;">
              <thead class="table-light">
                <tr>
                  <th class="text-center" scope="col">TEKNISI REKANAN</th>
              ...
              <tbody>
                ...
                <tr>
                  <td align="center">{{ $item->teknisi_rekanan_reg ?? "-" }}</td>
