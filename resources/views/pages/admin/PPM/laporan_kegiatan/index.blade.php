                    ...
                    <table class="datatable table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr class="odd gradeX">
                          ...
                          <td>
                            <form
                              action="{{ url('/dashboard/ppm/laporan_kegiatan', $item->id_perbaikan_reg) }}" method="POST" class="d-inline">
                              @csrf
                              @method('DELETE')
                    ...
                    <table class="datatable table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                          <form action="{{ url('/dashboard/ppm/laporan_kegiatan_un',$item->id_perbaikan_un) }}" method="POST" class="d-inline">
                              @csrf
                              @method('DELETE')
                    ...
                    <table class="table table-hover table-bordered " id="scollDatatable" style="width:100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                          <form
                            action="{{ url('/dashboard/ppm/laporan_kegiatan_ppm', $item->id_ppm) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')    
                            <button class="btn btn-danger btn-xs"
                              data-toggle="tooltip" data-placement="top" title="Hapus">
