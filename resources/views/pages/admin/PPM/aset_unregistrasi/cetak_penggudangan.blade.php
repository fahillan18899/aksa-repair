...
@section('title', 'Cetak Penghapusan Un')
@push('addon-style')
<style>
  .td-custom {
                ...
                <tbody>
                  <tr>
                    <th width="7%" colspan="2">
                      <h3 class="text-center ">REPORT FORM PENGGUDANGAN UNREGISTRASI</h3>
                    </th>
                    <th width="7%" colspan="2">
                    </th>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td class="td-custom"><?php echo $item['tanggal_penggudangan_un'] ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="td-custom"><?php echo $item['keterangan_penggudangan_un'] ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="text-align: center;" class="td-custom" width="25%">Teknisi 1</td>
                    <td style="text-align: center;" class="td-custom" width="25%">Kepala Ruangan</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="text-align: center;" class="td-custom"><?php echo $item['teknisi_1_un'] ?></td>
                    <td style="text-align: center;" class="td-custom"><?php echo $item['ka_instalasi_un'] ?></td>
                  </tr>
                </tbody>
              </table>
            </div>
