              ...
              <table width="84%" border="1px dot yellow" cellspacing="10" style="margin: 5% 0 0 8%">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="td-custom"><?php echo $item['tanggal_pengembalian_un']; ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="td-custom"><?php echo $item['teknisi_2_un']; ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="td-custom"><?php echo $item['peneriama_alat_un']; ?></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="text-align: center;" class="td-custom"><?php echo $item['teknisi_rekanan_un']; ?></td>
                    <td style="text-align: center;" class="td-custom"><?php echo $item['pelapor_un']; ?></td>
                  </tr>
