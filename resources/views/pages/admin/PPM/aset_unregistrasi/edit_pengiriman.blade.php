              ...
              <div class="col-md-9 col-sm-12">
                <form action="{{ route('update_pengiriman_un.update', $item->id_perbaikan_un) }}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                      <input name="suku_cadang_un" type="text" class="form-control" id="suku_cadang_un1" value="<?= $item['suku_cadang_un'] ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                      <input name="volume_un" type="text" class="form-control" id="volume_un1" value="<?= $item['volume_un'] ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                      <input name="harga_satuan_un" type="text" class="form-control" id="harga_satuan_un1" value="<?= $item['harga_satuan_un'] ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                      <input name="jumlah_harga_un" type="text" class="form-control" id="jumlah_harga_un1" value="<?= $item['jumlah_harga_un'] ?>">
                    </div>
                  </div>
