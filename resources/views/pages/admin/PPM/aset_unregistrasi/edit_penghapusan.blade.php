...
@section('title', 'Edit Penghapusan Un')
@section('content')
          ...
          <div class="panel-body panel-form">
            <div class="row">
              <div class="col-md-9 col-sm-12">
                <form action="{{ route('update_penghapusan_un.update', $item->id_perbaikan_un) }}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-xs-9">
                      <input name="ka_instalasi_un" type="text" class="form-control" id="ka_instalasi_un" placeholder="Kepala Ruangan" value="<?= $item['ka_instalasi_un']  ?>">
                    </div>
                  </div>

                  <div class="form-group row">
                    <label for="keterangan_penggudangan_un" class="col-xs-3 col-form-label">Keterangan Penggudangan</label>
                    <div class="col-xs-9">
                      <input name="keterangan_penggudangan_un" type="text" class="form-control" id="keterangan_penggudangan_un" placeholder="Keterangan Pengguna" value="<?= $item['keterangan_penggudangan_un']  ?>">
                    </div>
                  </div>
