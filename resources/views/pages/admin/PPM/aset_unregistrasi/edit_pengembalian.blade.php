              ...
              <div class="col-md-9 col-sm-12">
                <form action="{{ route('update_pengembalian_un.update', $item->id_perbaikan_un) }}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                  ...
                  <div class="form-group row">
                    <label for="id_perbaikan_un" class="col-xs-3 col-form-label">id pengembalian</label>
                    <div class="col-xs-9">
                  ...
                  <div class="form-group row">
                    <label for="tanggal_pengembalian_un" class="col-xs-3 col-form-label">Tanggal Pengembalian</label>
                    <div class="col-xs-9">
                  ...
                  <div class="form-group row">
                    <label for="peneriama_alat_un" class="col-xs-3 col-form-label">Peneriama Alat</label>
                    <div class="col-xs-9">
