...
@section('title', 'show lk dhiatermy')
@push('addon-style')
<style>
  .td-custom {
        ...
        <div class="panel panel-default thumbnail">
          ...
          <div class="card" id="PrintMe">
            <div class="align-center mt-5">
              ...
              <img src="{{ url('assets/kop-surat/kop surat diathermy2.png') }}" alt="Kop Klaten" width="100%">
              @endif
            </div>
            <h3><center>LAPORAN PEMELIHARAAN DIATHERMY</center></h3>
