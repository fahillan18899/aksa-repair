                 ...
                 <form action="{{ route('pesanan_user.store')}}" class="form-inner" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                     ...
                     <div class="col-xs-9">
                       <input name="id_req" type="text" class="form-control" id="id_qr" placeholder="Input id aset / scan dari qr">
                     </div>
                   </div>
                   <div class="form-group row">
                   ...
                   <div class="form-group row">
                     ...
                     <div class="col-xs-9">
                       <input name="lokasi_req" type="text" class="form-control" id="lokasi_req" placeholder="Serial Number" value="" readonly>
                     </div>
                   </div>
                   <div class="form-group row">
                 ...
                 <table class="datatable table table-striped table-bordered" style="width:100%">
                   ...
                   <tbody>
                     ...
                     <tr>
                       ...
                       <td>
                         <form action="{{ route('pesanan_user.destroy' ,$item->id_req) }}" method="POST" class="d-inline">
                           @csrf
                           @method('delete')
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const inputField = document.getElementById("id_qr");
