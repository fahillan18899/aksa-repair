...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('defibrilator_monitors', function (Blueprint $table) {
            /**Data alat pelanggan */
            $table->id()->primary();
            ...
            //energi joule
            $table->string('energij_1')->nullable();
            $table->string('energij_2')->nullable();
            $table->string('energij_3')->nullable();
    ...
    {
        Schema::dropIfExists('defibrilator_monitors');
    }
};
