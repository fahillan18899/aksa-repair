...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('electrolits', function (Blueprint $table) {
            /**Data alat pelanggan */
            $table->id()->primary();
            ...
            $table->string('range_normal_1')->nullable();
            $table->string('range_normal_2')->nullable();
    ...
    {
        Schema::dropIfExists('electrolits');
    }
};
