...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('cardiotocographs', function (Blueprint $table) {
            /**Data alat pelanggan */
            $table->id()->primary();
            ...
            $table->string('frekuensi40_1')->nullable();
            $table->string('frekuensi40_2')->nullable();
            $table->string('frekuensi40_3')->nullable();
            $table->string('frekuensi60_1')->nullable();
            $table->string('frekuensi60_2')->nullable();
            $table->string('frekuensi60_3')->nullable();
            $table->string('frekuensi120_1')->nullable();
            $table->string('frekuensi120_2')->nullable();
            $table->string('frekuensi120_3')->nullable();
            $table->string('frekuensi180_1')->nullable();
            $table->string('frekuensi180_2')->nullable();
            $table->string('frekuensi180_3')->nullable();
            $table->string('frekuensi240_1')->nullable();
            $table->string('frekuensi240_2')->nullable();
            $table->string('frekuensi240_3')->nullable();
    ...
    {
        Schema::dropIfExists('cardiotocographs');
    }
};
